              ...
              <th align="center">
                <table border="0" style="width:100%;height:100%;border:0;padding:0;margin:0;max-width:600px;background:#fff;border-radius:3px;">
                    ...
                    <tr>
                      <th>
                        <table style="">
                          ...
                          <th width="300px;">
                            <img style="width:300px;" src="http://7sbxv9.com1.z0.glb.clouddn.com/logo.png" alt="NKUOJ" title="NKUOJ" />
                          </th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th>
                        <a style="padding:14px 28px 14px 28px;width:200px;height:1.5em;background:#ffa7be;display:inline-block;line-height:1.5em;color:#fff;border-radius:3px;text-decoration:none;" href="#">code:${code}</a>
                      </th>
                    </tr>
                    <tr height="10"></tr>
                    <tr>
                    ...
                    <tr>
                      <th>
                        <a style="padding:14px 28px 14px 28px;width:200px;height:1.5em;background:#ff2b63;display:inline-block;line-height:1.5em;color:#fff;border-radius:3px;text-decoration:none;" href="${link}">验证邮件地址</a>
                      </th>
                    </tr>
                    <tr height="30">
                        <th>
