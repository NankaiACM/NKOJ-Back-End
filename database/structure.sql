...
CREATE UNIQUE INDEX lower_nickname_idx
  ON user_nick ((lower(nickname)));
...
CREATE SEQUENCE problems_problem_name_seq
  START 1000;

CREATE TABLE problems (
  problem_id    serial PRIMARY KEY,
  problem_name  integer UNIQUE NOT NULL DEFAULT nextval('problems_problem_name_seq'),
...
ALTER SEQUENCE problems_problem_name_seq
  OWNED BY problems.problem_name;
