...
module.exports = (server) => {
  ...
  wss.on('headers', (headers) => {
    ...
    headers.push('Access-Control-Allow-Origin: http://acm.nankai.edu.cn')
    headers.push('Access-Control-Allow-Headers: Sec-WebSocket-Extensions')
    headers.push('Access-Control-Allow-Headers: Sec-WebSocket-Key')
    headers.push('Access-Control-Allow-Headers: Sec-WebSocket-Version')
  })
}
