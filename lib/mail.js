        ...
        <body style="height:100%;width:100%;padding:0;margin:0;">
          <table style="background:#eaeced;" align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" bgcolor="#eaeced">
            ...
            <tr>
              <td width="50"></td>
              <td align="center">
                <table border="0" style="width:100%;height:100%;border:0;padding:0;margin:0;max-width:600px;background:#fff;border-radius:3px;" align="center">
                  <tbody align="center">
                    <tr height="50"></tr>
                    <tr>
                      <td>
