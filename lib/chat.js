...
const rebuild = async (ws, type) => {
  switch (type) {
    ...
    case 'backend':
      ...
      ws.send(formMessage(1, 0, 'SYSTEM', bres.stdout))
      ...
      break
    default:
      ws.send(formMessage(1, 0, 'SYSTEM', 'unknown type'))
  }
}
